...
import { Fingerprint, CheckCircle2, Search, ArrowRight, ShieldCheck, Cpu, LogIn, Sun, Moon } from 'lucide-react';
...
export const LandingPage = () => {
    ...
    return (
        <div className="relative min-h-screen bg-background overflow-hidden">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-white/10 px-6 py-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xl font-bold bg-clip-text text-transparent bg-accent-gradient">SBMS AI</span>
                    </div>

                    <div className="flex items-center space-x-4">
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-text"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center space-x-2 px-5 py-2 rounded-xl bg-accent-gradient border border-white/10 hover:opacity-90 transition-opacity text-sm font-bold text-white shadow-[0_0_15px_rgba(106,0,255,0.4)]"
                        >
            ...
            <div className="relative max-w-7xl mx-auto mt-24 min-h-[80vh] flex flex-col justify-center px-6">
